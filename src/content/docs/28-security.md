---
title: "Security"
description: "This page describes the security boundaries the library does and does not enforce. Payable does not authenticate callers. The host application owns..."
sidebar:
  order: 28
---
