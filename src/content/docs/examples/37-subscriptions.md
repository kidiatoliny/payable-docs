...
description: "Create a provider-independent recurring agreement from a logical customer and canonical price:"
sidebar:
  order: 37
---
...
See [Subscriptions](/features/10-subscriptions/) for provider capability and state details.

For provider-gated upgrade, downgrade, failed-payment, pause, and resume flows, continue with
[Advanced Subscription Operations](/examples/47-subscription-operations/).
