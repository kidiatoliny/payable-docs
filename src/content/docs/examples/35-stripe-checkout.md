...
description: "Create a Stripe-hosted subscription checkout and redirect the customer to the returned URL."
sidebar:
  order: 35
---
...
[Getting Started](/03-getting-started/) for the complete setup.
...
fields form Payable's idempotency key. See [Stripe Provider](/integrations/18-stripe/) for webhook
