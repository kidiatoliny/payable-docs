...
description: "Manage a provider-neutral local catalog, or use an explicit provider catalog when the remote payment provider owns the product and price records."
sidebar:
  order: 45
---
