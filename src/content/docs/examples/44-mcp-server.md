---
title: "MCP Server"
description: "Expose Payable's billing resources and guarded operations to an MCP client."
sidebar:
  order: 44
---
...
at the edge, and keep DNS-rebinding protection enabled. See [MCP Adapter](/adapters/26-mcp/).
