---
title: "Trust My Travel credentials"
description: "Use this runbook to locate the four values required by TrustMyTravelProvider and place them in approved server-side configuration. It applies to a Trust My..."
sidebar:
  order: 20
---
...
[Test certification runbook](/integrations/20b-trust-my-travel-test-certification/). Its suite is opt-in and
