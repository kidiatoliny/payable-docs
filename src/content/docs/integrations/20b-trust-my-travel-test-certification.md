---
title: "Trust My Travel Test certification"
description: "The Trust My Travel integration suite exercises the adapter against a real Test channel. It is excluded from every standard test and coverage run. Run it..."
sidebar:
  order: 20
---
