...
description: "Stripe Treasury, including its independent webhook verifier, is implemented by the separate StripeTreasuryProvider; see Stripe Treasury."
sidebar:
  order: 18
---

Stripe Treasury, including its independent webhook verifier, is implemented by the separate
`StripeTreasuryProvider`; see [Stripe Treasury](/integrations/18a-stripe-treasury/).
