...
provider-hosted page instead of creating it directly - see [09-checkout](/features/09-checkout/).
...
See the [provider subscription operation matrix](/integrations/17-providers/#subscription-operation-capabilities)
...
[07-state-machines](/domain/07-state-machines/).
