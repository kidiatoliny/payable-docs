...
description: "PrismaStorageDriver is an official storage adapter that satisfies the same StorageDriver contract as KnexStorageDriver, backed by a Prisma Client. It is..."
sidebar:
  order: 21
---
...
[Upgrading from 1.0.0-beta6](/32a-upgrading-from-beta6/). Do not accept destructive generated SQL
