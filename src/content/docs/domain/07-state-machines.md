...
description: "State machines live in src/domain/states/. There is one per lifecycle-bearing entity: subscription, invoice, payment, refund. Each machine constrains which..."
sidebar:
  order: 7
---
